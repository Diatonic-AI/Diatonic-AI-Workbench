...
async function handleSubscriptionCreated(event: StripeSubscriptionEvent): Promise<WebhookProcessResult> {
...
async function handleSubscriptionUpdated(event: StripeSubscriptionEvent): Promise<WebhookProcessResult> {
  const subscription = event.data.object;
  const customerId = subscription.customer;
...
async function handleSubscriptionDeleted(event: StripeSubscriptionEvent): Promise<WebhookProcessResult> {
  const subscription = event.data.object;
  const customerId = subscription.customer;
...
// Stripe payment event interface
...
// Stripe customer event interface
...
async function handlePaymentSucceeded(event: StripePaymentEvent): Promise<WebhookProcessResult> {
...
async function handlePaymentFailed(event: StripePaymentEvent): Promise<WebhookProcessResult> {
  const invoice = event.data.object;
  const customerId = invoice.customer;
...
async function handleCustomerCreated(event: StripeCustomerEvent): Promise<WebhookProcessResult> {
...
async function handleCustomerUpdated(event: StripeCustomerEvent): Promise<WebhookProcessResult> {
  const customer = event.data.object;
...
// Generic webhook body and headers interfaces
...
async function handleGitHubWebhook(body: GenericWebhookBody, headers: WebhookHeaders): Promise<WebhookProcessResult> {
...
async function handleSlackWebhook(body: GenericWebhookBody, headers: WebhookHeaders): Promise<WebhookProcessResult> {
...
async function handleDiscordWebhook(body: GenericWebhookBody, headers: WebhookHeaders): Promise<WebhookProcessResult> {
...
async function handleOpenAIWebhook(body: GenericWebhookBody, headers: WebhookHeaders): Promise<WebhookProcessResult> {
...
async function handleGenericWebhook(serviceName: string, body: GenericWebhookBody, headers: WebhookHeaders): Promise<WebhookProcessResult> {
...
// Helper functions
async function findTenantByStripeCustomerId(customerId: string): Promise<MockTenant> {
...
async function recordWebhookEvent(webhookEvent: WebhookEventRecord): Promise<void> {
...
async function emitDomainEvent(event: DomainEvent): Promise<void> {
