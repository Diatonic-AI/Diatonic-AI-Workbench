...
async function getUsageBreakdown(tenantId: string, startDate: Date, endDate: Date, granularity: string): Promise<UsagePeriod[]> {
...
async function getBillingData(tenantId: string, startDate: Date, endDate: Date): Promise<BillingData> {
...
function generateOptimizationRecommendations(usageStats: Record<string, unknown>): OptimizationRecommendation[] {
...
async function generateDetailedRecommendations(usageStats: Record<string, unknown>, category?: string, priority?: string): Promise<OptimizationRecommendation[]> {
...
async function getResourceUtilizationData(tenantId: string, startDate: Date, endDate: Date, resourceType?: string): Promise<ResourceUtilizationData> {
...
function generateTrendData(startDate: Date, endDate: Date): TrendDataPoint[] {
