...
export const errorMiddleware = async (
  ...
  let details: ValidationErrorDetails | Record<string, unknown> | undefined = undefined;
...
export class ApplicationError extends Error implements AppError {
  ...
  public code: string;
  public details?: ValidationErrorDetails | Record<string, unknown>;

  constructor(message: string, statusCode = 500, code = 'InternalServerError', details?: ValidationErrorDetails | Record<string, unknown>) {
    super(message);
...
export class ValidationError extends ApplicationError {
  constructor(message: string, details?: ValidationErrorDetails | Record<string, unknown>) {
