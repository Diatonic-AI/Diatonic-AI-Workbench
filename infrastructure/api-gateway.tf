...
resource "aws_api_gateway_deployment" "main" {
  ...
  depends_on = [
    ...
    aws_api_gateway_method.lead_get,
    aws_api_gateway_method.lead_put,
    aws_api_gateway_method.lead_individual_options,
    aws_api_gateway_method.lead_analytics_get,
    aws_api_gateway_method.lead_analytics_options,
    ...
    aws_api_gateway_integration.lead_get_integration,
    aws_api_gateway_integration.lead_put_integration,
    aws_api_gateway_integration.lead_individual_options_integration,
    aws_api_gateway_integration.lead_analytics_get_integration,
    aws_api_gateway_integration.lead_analytics_options_integration,
  ]
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_resource.leads.id,
      aws_api_gateway_resource.lead_individual.id,
      aws_api_gateway_resource.lead_analytics.id,
      aws_api_gateway_method.leads_post.id,
      aws_api_gateway_method.leads_get.id,
      aws_api_gateway_method.lead_get.id,
      aws_api_gateway_method.lead_put.id,
      aws_api_gateway_method.lead_analytics_get.id,
    ]))
  }
