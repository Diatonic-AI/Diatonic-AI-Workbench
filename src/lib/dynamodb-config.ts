...
export const TABLES = {
  LANDING_PAGES: `${TABLE_PREFIX}-diatonic-ai-landing-pages`,
  PAGE_SECTIONS: `${TABLE_PREFIX}-diatonic-ai-page-sections`,
  SEO_METADATA: `${TABLE_PREFIX}-diatonic-ai-seo-metadata`,
  FEATURES: `${TABLE_PREFIX}-diatonic-ai-features`,
  TESTIMONIALS: `${TABLE_PREFIX}-diatonic-ai-testimonials`,
  PRICING_PLANS: `${TABLE_PREFIX}-diatonic-ai-pricing-plans`,
} as const;
