// AWS DynamoDB Client Configuration for AI Nexus Workbench
...
export const TABLE_NAMES = {
  AGENT_TEMPLATES: `aws-devops-${getEnvironment()}-agent-templates`,
  FLOW_NODE_CONFIGS: `aws-devops-${getEnvironment()}-flow-node-configs`,
  AGENT_EXECUTION_HISTORY: `aws-devops-${getEnvironment()}-agent-execution-history`,
  LAB_MODEL_REGISTRY: `aws-devops-${getEnvironment()}-lab-model-registry`,
  EXPERIMENT_RUN_LOGS: `aws-devops-${getEnvironment()}-experiment-run-logs`,
} as const;
