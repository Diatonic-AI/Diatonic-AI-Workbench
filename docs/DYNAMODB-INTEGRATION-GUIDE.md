...
A complete guide for managing DynamoDB schema, data synchronization, and cloud integration in the Diatonic AI project.
...
### **Schema Consistency**
- **Local Format**: `diatonic-ai-platform-development-{table}`
- **Cloud Format**: `diatonic-ai-platform-{environment}-{table}`
