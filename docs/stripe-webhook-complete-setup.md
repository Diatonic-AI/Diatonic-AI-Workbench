...
aws logs describe-log-groups --log-group-name-prefix "/aws/lambda/diatonic-ai-platform"
```
...
{
  "status": "healthy",
  "service": "diatonic-ai-platform-webhooks",
...
- **Log Group:** `/aws/lambda/diatonic-ai-platform-dev-main-api`
- **API Gateway Logs:** `/aws/apigateway/diatonic-ai-platform-dev-main-api`
